...
$insert_html.= Page_Lib::loadJs('usersupervise');
$insert_html .= Page_Lib::loadJs('superviserole');
...
<div id="breadcrumb">
    ...
    <a href="#" class="current">处理账号所有角色</a>
 </div>
...
<div class="modal fade" id="forbidAccountModal" tabindex="-1" role="dialog" aria-labelledby="forbidAccountModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="/rolesupervise/save/" method="POST" id="forbidAccountForm" onsubmit="return false;">                     
